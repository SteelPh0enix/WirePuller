...
public:
    //! Default constructor
    /*!
        Note: If you default-construct, you have to use initialize() in order to use the object
        or every bool-returning function will return false
        \see initialize
    */
    Endstop() = default;
    ...
    */
    ...
    /*!
        \return true if endstop is hit, false if not or if object is not initialized
    */
    bool state() const {
